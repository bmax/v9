...
expression:  expression '+' expression {
        ...
        |    NUMBER '(' expression ')' {
               $$ = new ASTNode_NumberCast($3);
               $$->SetLineNum(line_num);
            }
        |    STRING '(' expression ')' {
               $$ = new ASTNode_StringCast($3);
               $$->SetLineNum(line_num);
            }
        |    BOOLEAN '(' expression ')' {
        ...
        |    var_usage '.' PUSH '(' expression ')' {
               $$ = new ASTNode_Push($1, $5);
            }
        |    var_usage '.' POP '(' ')' {
               $$ = new ASTNode_Pop($1);
            }
